 ...
 *
 * @method     \ItemOptionQuery|\RegistrationOptionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class OptionValueQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\OptionValueQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\OptionValue', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \ItemOption object
     *
     * @param \ItemOption|ObjectCollection $itemOption The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($itemOption instanceof \ItemOption) {
            return $this
            ...
            throw new PropelException('filterByItemOption() only accepts arguments of type \ItemOption or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ItemOptionQuery A secondary query class using the current class as primary query
     */
    public function useItemOptionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinItemOption($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ItemOption', '\ItemOptionQuery');
    }
