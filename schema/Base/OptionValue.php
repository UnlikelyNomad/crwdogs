...
abstract class OptionValue implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OptionValueTableMap';
    ...
    /**
     * Initializes internal state of Base\OptionValue object.
     */
     ...
     * @return $this|\OptionValue The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\OptionValue'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OptionValue (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OptionValue Clone of current object.
     * @throws PropelException
     */
