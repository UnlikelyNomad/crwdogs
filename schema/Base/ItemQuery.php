 ...
 *
 * @method     \EventQuery|\ItemOptionQuery|\PurchasedItemQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ItemQuery extends ModelCriteria
{
     ...
     *
     * @param \ItemOption|ObjectCollection $itemOption the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildItemQuery The current query, for fluid interface
     */
