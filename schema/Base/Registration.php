...
abstract class Registration implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RegistrationTableMap';
    ...
    /**
     * Initializes internal state of Base\Registration object.
     */
     ...
     * @return $this|\Registration The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Registration'), 0, $e);
        }
    }
    ...
    public function initPurchasedItems($overrideExisting = true)
    {
        ...
        $this->collPurchasedItems->setModel('\PurchasedItem');
    }
