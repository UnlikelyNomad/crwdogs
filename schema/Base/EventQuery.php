 ...
 *
 * @method     \LocationQuery|\EarlyDiscountQuery|\ItemQuery|\QuestionQuery|\RegistrationQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \EarlyDiscount object
     *
     * @param \EarlyDiscount|ObjectCollection $earlyDiscount the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventQuery The current query, for fluid interface
     */
    ...
    {
        if ($earlyDiscount instanceof \EarlyDiscount) {
            return $this
            ...
            throw new PropelException('filterByEarlyDiscount() only accepts arguments of type \EarlyDiscount or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EarlyDiscountQuery A secondary query class using the current class as primary query
     */
    public function useEarlyDiscountQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EarlyDiscount', '\EarlyDiscountQuery');
    }
     ...
     *
     * @param \Registration|ObjectCollection $registration the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventQuery The current query, for fluid interface
     */
