...
use \RegistrationOption as ChildRegistrationOption;
...
/**
 * Base class that represents a row from the 'purchased_item' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class PurchasedItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PurchasedItemTableMap';
    ...
    /**
     * Initializes internal state of Base\PurchasedItem object.
     */
    ...
    /**
     * Compares this with another <code>PurchasedItem</code> instance.  If
     * <code>obj</code> is an instance of <code>PurchasedItem</code>, delegates to
     * <code>equals(PurchasedItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PurchasedItem The current object, for fluid interface
     */
     ...
     * @return $this|\PurchasedItem The current object (for fluent API support)
     */
    public function setPurchaseId($v)
    {
        ...
        if ($this->purchase_id !== $v) {
            $this->purchase_id = $v;
            $this->modifiedColumns[PurchasedItemTableMap::COL_PURCHASE_ID] = true;
        }
    ...
    public function setRegistrationId($v)
    {
        ...
        if ($this->registration_id !== $v) {
            ...
            $this->modifiedColumns[PurchasedItemTableMap::COL_REGISTRATION_ID] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[PurchasedItemTableMap::COL_QTY] = true;
        }
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[PurchasedItemTableMap::COL_ITEM_ID] = true;
        }
    ...
    public function setUnitCost($v)
    {
        ...
        if ($this->unit_cost !== $v) {
            $this->unit_cost = $v;
            $this->modifiedColumns[PurchasedItemTableMap::COL_UNIT_COST] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PurchasedItemTableMap::translateFieldName('PurchaseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->purchase_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PurchasedItemTableMap::translateFieldName('RegistrationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->registration_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PurchasedItemTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PurchasedItemTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PurchasedItemTableMap::translateFieldName('UnitCost', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = PurchasedItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PurchasedItem'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPurchasedItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PurchasedItem::setDeleted()
     * @see PurchasedItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPurchasedItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PurchasedItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->registrationOptionsScheduledForDeletion !== null) {
                if (!$this->registrationOptionsScheduledForDeletion->isEmpty()) {
                    \RegistrationOptionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PurchasedItemTableMap::COL_PURCHASE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'purchase_id';
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_REGISTRATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'registration_id';
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'qty';
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'item_id';
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_UNIT_COST)) {
            $modifiedColumns[':p' . $index++]  = 'unit_cost';
        }

        $sql = sprintf(
            'INSERT INTO purchased_item (%s) VALUES (%s)',
    ...
    {
        $pos = PurchasedItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PurchasedItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PurchasedItem'][$this->hashCode()] = true;
        $keys = PurchasedItemTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchasedItemTableMap::COL_PURCHASE_ID)) {
            $criteria->add(PurchasedItemTableMap::COL_PURCHASE_ID, $this->purchase_id);
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_REGISTRATION_ID)) {
            $criteria->add(PurchasedItemTableMap::COL_REGISTRATION_ID, $this->registration_id);
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_QTY)) {
            $criteria->add(PurchasedItemTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_ITEM_ID)) {
            $criteria->add(PurchasedItemTableMap::COL_ITEM_ID, $this->item_id);
        }
        if ($this->isColumnModified(PurchasedItemTableMap::COL_UNIT_COST)) {
            $criteria->add(PurchasedItemTableMap::COL_UNIT_COST, $this->unit_cost);
        }
    ...
    {
        $criteria = ChildPurchasedItemQuery::create();
        $criteria->add(PurchasedItemTableMap::COL_PURCHASE_ID, $this->purchase_id);
    ...
    /**
     * Generic method to set the primary key (purchase_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PurchasedItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PurchasedItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function getItem(ConnectionInterface $con = null)
    {
        if ($this->aItem === null && ($this->item_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aItem->addPurchasedItems($this);
             */
        }
    ...
    public function getRegistration(ConnectionInterface $con = null)
    {
        if ($this->aRegistration === null && ($this->registration_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegistration->addPurchasedItems($this);
             */
        }
    ...
    public function initRegistrationOptions($overrideExisting = true)
    {
        ...
        $this->collRegistrationOptions->setModel('\RegistrationOption');
    }
     ...
     * If this ChildPurchasedItem is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPurchasedItem The current object (for fluent API support)
     */
    public function setRegistrationOptions(Collection $registrationOptions, ConnectionInterface $con = null)
    {
        ...
        foreach ($registrationOptionsToDelete as $registrationOptionRemoved) {
            $registrationOptionRemoved->setPurchasedItem(null);
        }
    ...
    protected function doAddRegistrationOption(ChildRegistrationOption $registrationOption)
    {
        ...
        $registrationOption->setPurchasedItem($this);
    }
    ...
    public function removeRegistrationOption(ChildRegistrationOption $registrationOption)
    {
        if ($this->getRegistrationOptions()->contains($registrationOption)) {
            ...
            $registrationOption->setPurchasedItem(null);
        }
     ...
     * Otherwise if this PurchasedItem is new, it will return
     * an empty collection; or if this PurchasedItem has previously
     * been saved, it will retrieve related RegistrationOptions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PurchasedItem.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildRegistrationOption[] List of ChildRegistrationOption objects
     */
    public function getRegistrationOptionsJoinOptionValue(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildRegistrationOptionQuery::create(null, $criteria);
        $query->joinWith('OptionValue', $joinBehavior);
    ...
    {
        if (null !== $this->aItem) {
            $this->aItem->removePurchasedItem($this);
        }
        if (null !== $this->aRegistration) {
            $this->aRegistration->removePurchasedItem($this);
        }
    ...
    {
        return (string) $this->exportTo(PurchasedItemTableMap::DEFAULT_STRING_FORMAT);
    }
