...
use \RegistrationOption;
use \RegistrationOptionQuery;
...
class RegistrationOptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.RegistrationOptionTableMap';
     ...
     */
    const OM_CLASS = '\\RegistrationOption';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'RegistrationOption';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\RegistrationOption');
        $this->setPackage('');
    ...
    {
        $this->addRelation('PurchasedItem', '\\PurchasedItem', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':purchase_id',
    1 => ':purchase_id',
        ...
        $this->addRelation('OptionValue', '\\OptionValue', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':value_id',
    1 => ':value_id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \RegistrationOption) { // it's a model object
