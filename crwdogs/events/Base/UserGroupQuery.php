 ...
 *
 * @method     ChildUserGroupQuery leftJoinAuthGroup($relationAlias = null) Adds a LEFT JOIN clause to the query using the AuthGroup relation
 * @method     ChildUserGroupQuery rightJoinAuthGroup($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AuthGroup relation
 * @method     ChildUserGroupQuery innerJoinAuthGroup($relationAlias = null) Adds a INNER JOIN clause to the query using the AuthGroup relation
 *
 * @method     ChildUserGroupQuery joinWithAuthGroup($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AuthGroup relation
 *
 * @method     ChildUserGroupQuery leftJoinWithAuthGroup() Adds a LEFT JOIN clause and with to the query using the AuthGroup relation
 * @method     ChildUserGroupQuery rightJoinWithAuthGroup() Adds a RIGHT JOIN clause and with to the query using the AuthGroup relation
 * @method     ChildUserGroupQuery innerJoinWithAuthGroup() Adds a INNER JOIN clause and with to the query using the AuthGroup relation
 *
 ...
 *
 * @method     \crwdogs\events\AuthGroupQuery|\crwdogs\events\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserGroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \crwdogs\events\Base\UserGroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\crwdogs\\events\\UserGroup', $modelAlias = null)
    {
    ...
    public function filterByAuthGroup($authGroup, $comparison = null)
    {
        if ($authGroup instanceof \crwdogs\events\AuthGroup) {
            return $this
                ->addUsingAlias(UserGroupTableMap::COL_GROUP_ID, $authGroup->getGroupId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserGroupTableMap::COL_GROUP_ID, $authGroup->toKeyValue('PrimaryKey', 'GroupId'), $comparison);
        } else {
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \crwdogs\events\User) {
            return $this
                ->addUsingAlias(UserGroupTableMap::COL_USER_ID, $user->getUserId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserGroupTableMap::COL_USER_ID, $user->toKeyValue('PrimaryKey', 'UserId'), $comparison);
        } else {
