 ...
 *
 * @method     \crwdogs\events\ItemQuery|\crwdogs\events\OptionValueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ItemOptionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \crwdogs\events\Base\ItemOptionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\crwdogs\\events\\ItemOption', $modelAlias = null)
    {
     ...
     *
     * @param \crwdogs\events\Item|ObjectCollection $item The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \crwdogs\events\OptionValue|ObjectCollection $optionValue the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildItemOptionQuery The current query, for fluid interface
     */
