...
/**
 * Base class that represents a row from the 'response' table.
 *
 *
 *
...
abstract class Response implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\crwdogs\\events\\Map\\ResponseTableMap';
     ...
     * @return $this|\crwdogs\events\Response The current object (for fluent API support)
     */
    public function setResponseId($v)
    {
        ...
        if ($this->response_id !== $v) {
            $this->response_id = $v;
            $this->modifiedColumns[ResponseTableMap::COL_RESPONSE_ID] = true;
        }
    ...
    public function setQuestionId($v)
    {
        ...
        if ($this->question_id !== $v) {
            $this->question_id = $v;
            $this->modifiedColumns[ResponseTableMap::COL_QUESTION_ID] = true;
        }
    ...
    public function setRegistrationId($v)
    {
        ...
        if ($this->registration_id !== $v) {
            ...
            $this->modifiedColumns[ResponseTableMap::COL_REGISTRATION_ID] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[ResponseTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ResponseTableMap::translateFieldName('ResponseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->response_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ResponseTableMap::translateFieldName('QuestionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->question_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ResponseTableMap::translateFieldName('RegistrationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->registration_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ResponseTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ResponseTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\crwdogs\\events\\Response'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ResponseTableMap::COL_RESPONSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'response_id';
        }
        if ($this->isColumnModified(ResponseTableMap::COL_QUESTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'question_id';
        }
        if ($this->isColumnModified(ResponseTableMap::COL_REGISTRATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'registration_id';
        }
        if ($this->isColumnModified(ResponseTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO response (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\crwdogs\events\Response
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setResponseId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setQuestionId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setRegistrationId($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\crwdogs\events\Response The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ResponseTableMap::COL_RESPONSE_ID)) {
            $criteria->add(ResponseTableMap::COL_RESPONSE_ID, $this->response_id);
        }
        if ($this->isColumnModified(ResponseTableMap::COL_QUESTION_ID)) {
            $criteria->add(ResponseTableMap::COL_QUESTION_ID, $this->question_id);
        }
        if ($this->isColumnModified(ResponseTableMap::COL_REGISTRATION_ID)) {
            $criteria->add(ResponseTableMap::COL_REGISTRATION_ID, $this->registration_id);
        }
        if ($this->isColumnModified(ResponseTableMap::COL_VALUE)) {
            $criteria->add(ResponseTableMap::COL_VALUE, $this->value);
        }
    ...
    {
        $validPk = null !== $this->getResponseId();
     ...
     * objects.
     *
     * @param      object $copyObj An object of \crwdogs\events\Response (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \crwdogs\events\Response Clone of current object.
     * @throws PropelException
     */
    ...
    public function getRegistration(ConnectionInterface $con = null)
    {
        if ($this->aRegistration === null && ($this->registration_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegistration->addResponses($this);
             */
        }
    ...
    {
        if (null !== $this->aQuestion) {
            $this->aQuestion->removeResponse($this);
        }
        if (null !== $this->aRegistration) {
            $this->aRegistration->removeResponse($this);
        }
