...
abstract class PurchasedItem implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\crwdogs\\events\\Map\\PurchasedItemTableMap';
    ...
    /**
     * Initializes internal state of crwdogs\events\Base\PurchasedItem object.
     */
     ...
     * @return $this|\crwdogs\events\PurchasedItem The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\crwdogs\\events\\PurchasedItem'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\crwdogs\events\PurchasedItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\crwdogs\events\PurchasedItem The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \crwdogs\events\PurchasedItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \crwdogs\events\PurchasedItem Clone of current object.
     * @throws PropelException
     */
