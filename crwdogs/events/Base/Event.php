...
abstract class Event implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\crwdogs\\events\\Map\\EventTableMap';
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->earlyDiscountsScheduledForDeletion !== null) {
                if (!$this->earlyDiscountsScheduledForDeletion->isEmpty()) {
                    \crwdogs\events\EarlyDiscountQuery::create()
            ...
            if ($this->itemsScheduledForDeletion !== null) {
                if (!$this->itemsScheduledForDeletion->isEmpty()) {
                    \crwdogs\events\ItemQuery::create()
            ...
            if ($this->questionsScheduledForDeletion !== null) {
                if (!$this->questionsScheduledForDeletion->isEmpty()) {
                    \crwdogs\events\QuestionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\crwdogs\events\Event
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\crwdogs\events\Event The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \crwdogs\events\Event (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \crwdogs\events\Event Clone of current object.
     * @throws PropelException
     */
    ...
    public function initEarlyDiscounts($overrideExisting = true)
    {
        ...
        $this->collEarlyDiscounts->setModel('\crwdogs\events\EarlyDiscount');
    }
    ...
    public function initItems($overrideExisting = true)
    {
        ...
        $this->collItems->setModel('\crwdogs\events\Item');
    }
    ...
    public function initQuestions($overrideExisting = true)
    {
        ...
        $this->collQuestions->setModel('\crwdogs\events\Question');
    }
