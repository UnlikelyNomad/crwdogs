...
use crwdogs\events\Map\QuestionTableMap;
 ...
 *
 * @method     \crwdogs\events\EventQuery|\crwdogs\events\QuestionOptionQuery|\crwdogs\events\ResponseQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class QuestionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \crwdogs\events\Base\QuestionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\crwdogs\\events\\Question', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \crwdogs\events\QuestionOption object
     *
     * @param \crwdogs\events\QuestionOption|ObjectCollection $questionOption the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildQuestionQuery The current query, for fluid interface
     */
    ...
    {
        if ($questionOption instanceof \crwdogs\events\QuestionOption) {
            return $this
            ...
            throw new PropelException('filterByQuestionOption() only accepts arguments of type \crwdogs\events\QuestionOption or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \crwdogs\events\QuestionOptionQuery A secondary query class using the current class as primary query
     */
    public function useQuestionOptionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'QuestionOption', '\crwdogs\events\QuestionOptionQuery');
    }

    /**
     * Filter the query by a related \crwdogs\events\Response object
     *
     * @param \crwdogs\events\Response|ObjectCollection $response the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildQuestionQuery The current query, for fluid interface
     */
    ...
    {
        if ($response instanceof \crwdogs\events\Response) {
            return $this
            ...
            throw new PropelException('filterByResponse() only accepts arguments of type \crwdogs\events\Response or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \crwdogs\events\ResponseQuery A secondary query class using the current class as primary query
     */
    public function useResponseQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinResponse($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Response', '\crwdogs\events\ResponseQuery');
    }
