...
abstract class RegistrationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \crwdogs\events\Base\RegistrationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\crwdogs\\events\\Registration', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \crwdogs\events\Payment object
     *
     * @param \crwdogs\events\Payment|ObjectCollection $payment the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildRegistrationQuery The current query, for fluid interface
     */
    ...
    {
        if ($payment instanceof \crwdogs\events\Payment) {
            return $this
            ...
            throw new PropelException('filterByPayment() only accepts arguments of type \crwdogs\events\Payment or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \crwdogs\events\PaymentQuery A secondary query class using the current class as primary query
     */
    public function usePaymentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPayment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Payment', '\crwdogs\events\PaymentQuery');
    }
