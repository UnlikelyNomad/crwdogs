...
abstract class Question implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\crwdogs\\events\\Map\\QuestionTableMap';
    ...
    /**
     * Initializes internal state of crwdogs\events\Base\Question object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\crwdogs\events\Question The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\crwdogs\\events\\Question'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->questionOptionsScheduledForDeletion !== null) {
                if (!$this->questionOptionsScheduledForDeletion->isEmpty()) {
                    \crwdogs\events\QuestionOptionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\crwdogs\events\Question
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\crwdogs\events\Question The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \crwdogs\events\Question (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \crwdogs\events\Question Clone of current object.
     * @throws PropelException
     */
    ...
    public function initQuestionOptions($overrideExisting = true)
    {
        ...
        $this->collQuestionOptions->setModel('\crwdogs\events\QuestionOption');
    }
