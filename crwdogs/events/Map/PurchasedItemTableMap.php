...
class PurchasedItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'crwdogs.events.Map.PurchasedItemTableMap';
     ...
     */
    const OM_CLASS = '\\crwdogs\\events\\PurchasedItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'crwdogs.events.PurchasedItem';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\crwdogs\\events\\PurchasedItem');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \crwdogs\events\PurchasedItem) { // it's a model object
