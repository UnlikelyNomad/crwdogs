...
use crwdogs\events\Location;
use crwdogs\events\LocationQuery;
...
class LocationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'crwdogs.events.Map.LocationTableMap';
     ...
     */
    const OM_CLASS = '\\crwdogs\\events\\Location';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'crwdogs.events.Location';
     ...
     */
    const COL_STREET = 'location.street';

    /**
     * the column name for the city field
     */
    const COL_CITY = 'location.city';
     ...
     */
    const COL_ZIP = 'location.zip';

    /**
     * the column name for the google_link field
     */
    const COL_GOOGLE_LINK = 'location.google_link';
    ...
    /**
     * the column name for the amenities field
     */
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\crwdogs\\events\\Location');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationTableMap::COL_STREET);
            $criteria->addSelectColumn(LocationTableMap::COL_CITY);
            $criteria->addSelectColumn(LocationTableMap::COL_STATE);
            $criteria->addSelectColumn(LocationTableMap::COL_ZIP);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \crwdogs\events\Location) { // it's a model object
